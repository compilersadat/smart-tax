...
@section('content')
<section style="background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url('svg/smarttax.jpg');background-size:cover;height:630px;">
        ...
        <div class="col-md-5 ml-5">
            <div class="card pt-3 pb-3" style="box-shadow:none;">
                <div class="card-body px-4 text-font">
                                 <h3 class="h3 h3-responsive text-uppercase text-center black-text pb-4">{{ __('Login SmartTax') }}</h3>
    ...
    <div class="container py-3">
        <div class="row py-4">
            <div class="col-md-4">
                ...
                <!-- Title -->
                <h4 class="card-title"><a href="" class="site-color">Our Clients</a></h4>
                <!-- Text -->
            ...
            <div class="col-md-4">
                ...
                <!-- Title -->
                <h4 class="card-title"><a href="" class="site-color">Owner-Manager Business</a></h4>
                <!-- Text -->
            ...
            <div class="col-md-4">
                ...
                <!-- Title -->
                <h4 class="card-title"><a href="" class="site-color">Privately Held Companies</a></h4>
                <!-- Text -->
